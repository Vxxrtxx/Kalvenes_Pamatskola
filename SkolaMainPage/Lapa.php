    ...
    <div class="nav-wrapper">
        ...
        <div class="nav-left">
            ...
            <div class="dropdown" id="AdmissionDropdown">
                <a href="/<?= htmlspecialchars($project) ?>/Pienemsana/Uznemsana.html" class="hover-underline dropdown-trigger">Uzņemšana</a>
            </div>
        ...
        <?php else: ?>
            <div class="timeline-card">
                ...
                <div class="timeline-text">
                    ...
                    <a class="more-info-btn" href="/<?= htmlspecialchars($project) ?>/SkolaMainPage/detail.php?type=timeline&slug=izaugsmes ceļš">Vairāk informācija</a>
                </div>
            </div>
